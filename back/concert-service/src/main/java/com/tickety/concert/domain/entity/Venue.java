...
public class Venue {
    ...
    public void update(String name, String address, String city, Integer totalSeats, String description, String imageUrl) {
        if (name != null) this.name = name;
        if (address != null) this.address = address;
        if (city != null) this.city = city;
        if (totalSeats != null) this.totalSeats = totalSeats;
