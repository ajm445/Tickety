package com.tickety.concert.domain.entity;
...
public class Concert {
    ...
    public void update(String title, String artist, String description, OffsetDateTime concertDate,
                       OffsetDateTime bookingStartAt, OffsetDateTime bookingEndAt,
                       String posterUrl, Integer priceMin, Integer priceMax) {
